...
dem_esv$hli <- spatialEco::hli(dem_esv[[1]])
...
dem_pha$hli <- spatialEco::hli(dem_pha[[1]])
...
# topoterra
plot_visits |> pull(VisitDate) |> lubridate::year() |> unique()
climate_norms <- terra::rast("data/big/topoterra_hist_1961-2022.tif")
climate_2011 <- terra::rast("data/big/topoterra_hist_2011.tif")
...
climate_2022 <- terra::rast("data/big/topoterra_hist_2022.tif")
# climate_2023 <- terra::rast("data/big/topoterra_hist_2023.tif")
